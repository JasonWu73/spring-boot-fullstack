...
import { inputErrorClasses } from '@/components/ui/Input.tsx'
...
/**
 * {@link https://ui.shadcn.com/docs/components/select|Select - shadcn/ui}
 *
 * @param props - 组件属性
...
>(({ isError = false, className, children, ...props }, ref) => (
