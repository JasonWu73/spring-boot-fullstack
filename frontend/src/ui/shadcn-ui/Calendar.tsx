...
/**
 * {@link https://ui.shadcn.com/docs/components/calendar|Calendar - shadcn/ui}
 */
function Calendar({
  className,
  classNames,
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-sky-500 text-slate-50 hover:bg-sky-500 hover:text-slate-50 focus:bg-sky-500 focus:text-slate-50 dark:bg-sky-600 dark:text-slate-900 dark:hover:bg-sky-600 dark:hover:text-slate-900 dark:focus:bg-sky-600 dark:focus:text-slate-900',
        day_today:
