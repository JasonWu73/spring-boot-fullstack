...
class RsaUtilsTest {
  ...
  void generateKeyPair() {
    ...
    log.info("公钥: {}", rsaKeyPair.publicKey());
    log.info("私钥: {}", rsaKeyPair.privateKey());
  }
